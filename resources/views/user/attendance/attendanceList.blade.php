...
@section('content')
    <form class="d-flex " role="search" action="{{route('listAttendance')}}" method="GET">
        @csrf
    ...
    <div>
        <table class="table">
            ...
            <tr>
                ...
                <td>datphan</td>
                <td>
                    <a href="/attendance/show" class="btn btn-primary " role="button" aria-disabled="true">View</a>
                </td>
            </tr>
        </table>
    </div>
